...
public class CPUVoxelizer : MonoBehaviour
{
    ...
    public static VoxelOctree BuildVoxelTreeS(GameObject source, int res)
    {
        var meshFilter = source.GetComponent<MeshFilter>();
    ...
    public static VoxelOctree2 BuildVoxelTreeS2(GameObject source, int res)
    {
        var meshFilter = source.GetComponent<MeshFilter>();
        ...
        {
            float size = Mathf.Max(meshFilter.mesh.bounds.size.x, meshFilter.mesh.bounds.size.y, meshFilter.mesh.bounds.size.z);
            VoxelOctree2 octree = new VoxelOctree2(meshFilter.mesh.bounds.center, size, res);
    ...
    public static Octree BuildVoxelTreeR(GameObject source, int res)
    {
        var meshFilter = source.GetComponent<MeshFilter>();
        ...
        {
            float size = Mathf.Max(meshFilter.mesh.bounds.size.x, meshFilter.mesh.bounds.size.y, meshFilter.mesh.bounds.size.z);
            Octree octree = new Octree(meshFilter.mesh.bounds.center, size, res);
